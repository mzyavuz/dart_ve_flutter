          ...
          Column(
            children: [
              Row(
                ...
                children: [
                  IslemButonu(isaret: 'AC', islem: islem.sifirla(sayi),),
                  IslemButonu(isaret: '±', islem: islem.eksiDegeri(sayi)),
                  IslemButonu(isaret: '%', islem: islem.yuzdesi(sayi),),
                  IslemButonu(isaret: '÷', islem: islem.bolme(sayi, sayi2),),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                      ...
                      child: IslemButonu(isaret: '=', islem: islem.cikarma(sayi, sayi2))),
                ],
              ),
            ],
          ),
...
class IslemButonu extends StatefulWidget {
  ...
  final double islem;
  const IslemButonu({
    Key? key, required this.isaret, required this.islem,
  }) : super(key: key);
